using CleanArchitecture.Application.Features.Players.Commands.CreatePlayer;
using CleanArchitecture.Shared;
using CleanArchitecture.Application.Features.Players.Commands.DeletePlayer;
using CleanArchitecture.Application.Features.Players.Commands.UpdatePlayer;
using CleanArchitecture.Application.Features.Players.Queries.GetPlayersWithPagination;
using MediatR;
